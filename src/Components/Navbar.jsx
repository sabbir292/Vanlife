...
const Navbar = () => {
  return (
    <nav className='flex flex-row gap-5 justify-between bgprimary px-[26px] py-[36px] h-[14vh] list-none inter items-center mt-auto'>
      <Link to={'/'} className='uppercase mr-4 font-[900] text-[26px] xs:text-[20px]'>#Vanlife</Link>
      <li className='flex gap-4 font-[600] text-md xs:text-sm'>
        <NavLink
